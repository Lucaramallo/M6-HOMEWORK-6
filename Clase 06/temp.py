...
df = pd.read_csv('/Users/cristiancastro/Downloads/wine_reviews.csv', usecols = fields)
...
# ejecutar este codigo desde terminal streamlit run /Users/cristiancastro/.spyder-py3/temp.py
